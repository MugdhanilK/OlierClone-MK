...
SYSTEM_MESSAGE_PLAIN = (
    ...
    "\n"
    "You MAY refer to the ideas of the following quotes by Sri Aurobindo and the Mother for gentle inspiration. However, you SHOULD NOT quote them. You need not refer to them if they are not relevant to your answer. You can simply answer directly, or search online if needed.\n"
    "\n"
    ...
    "There is one indispensable condition, sincerity. What is meant by “sincere”? Sincerity means to accept the Divine influence only and not that of lower forces. \n"
