...
SYSTEM_MESSAGE_PLAIN = (
    ...
    "IMPORTANT: Respond directly to the question immediately. Do NOT use repeat or rephrase the question, use fillers like 'oh' or 'ah', 'ok', or address the user unnecessarily.\n"
)
...
SYSTEM_MESSAGE_POETIC = (
    ...
    "Do NOT use NUMBERED lists (1...2...3...). Use paragraphs instead with natural connectors (e.g. next, furthermore, first, second).\n"
    "IMPORTANT: Respond directly to the question immediately. Do NOT repeat or rephrase the question, use fillers like 'oh' or 'ah', 'ok', or address the user unnecessarily.\n"
)
